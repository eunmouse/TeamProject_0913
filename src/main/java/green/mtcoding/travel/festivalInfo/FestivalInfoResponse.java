...
public class FestivalInfoResponse {
    ...
    public static class FestivalMainDTO {
        ...
        public FestivalMainDTO(String contentId, String contentTypeId, String eventStartDate, String eventEndDate, String eventPlace, String originImgUrl, String title, String areaCode, String sigunguCode, boolean ongoing) {
            this.contentId = contentId;
            this.contentTypeId = contentTypeId;
            this.eventStartDate = eventStartDate;
            this.eventEndDate = eventEndDate;
